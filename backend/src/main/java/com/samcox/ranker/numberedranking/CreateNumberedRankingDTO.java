...
/**
 * DTO for creating a {@link NumberedRanking}.
 *
 * @see NumberedRanking
 * @see UserDTO
 * @see com.samcox.ranker.user.User
 */
public class CreateNumberedRankingDTO {
  /**
   ...
   */
  public CreateNumberedRankingDTO() {}
   ...
   */
  public CreateNumberedRankingDTO(String title, String desc, boolean isPublic, boolean isReverseOrder, String mediaType) {
    this.title = title;
