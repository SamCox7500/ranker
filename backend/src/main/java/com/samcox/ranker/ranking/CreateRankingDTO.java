...
/**
 * DTO for creating a {@link Ranking}.
 *
 * @see Ranking
 * @see UserDTO
...
public class CreateRankingDTO {
  ...
  /**
   * If the ranking is open to all user or just the owner.
   */
   ...
   */
  public CreateRankingDTO() {}
  /**
   * Constructor for creating Ranking objects
   */
  public CreateRankingDTO(String title, String desc, boolean isPublic) {
    this.title = title;
