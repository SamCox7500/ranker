...
public class NumberedRankingController {
  ...
  public List<NumberedRankingDTO> getAllRankings(@PathVariable("userId") long userId) {
  ...
  public NumberedRankingDTO getRanking(@PathVariable("rankingId") long rankingId, @PathVariable("userId") long userId) {
  ...
  public void createRanking(@PathVariable("userId") long userId, @Valid NumberedRankingDTO rankingDTO) {
  ...
  public void deleteRanking(@PathVariable("rankingId") long rankingId, @PathVariable("userId") long userId) {
