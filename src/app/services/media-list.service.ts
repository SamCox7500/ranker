...
export class MediaListService {
  ...
  public getMediaList(userId: number, rankingId: number, mediaListId: number) : Observable<MediaListEntry> {
    return this.http.get<MediaListEntry>(`${this.usersUrl}/${userId}/numberedrankings/${rankingId}/medialist/${mediaListId}`, {withCredentials: true});
  }
